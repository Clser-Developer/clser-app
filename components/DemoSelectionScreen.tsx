...
const DemoSelectionScreen: React.FC<DemoSelectionScreenProps> = ({ onSelectFan, onSelectArtist }) => {
  return (
    <div className="safe-screen safe-top-pad safe-bottom-pad relative flex flex-col items-center overflow-y-auto bg-[radial-gradient(circle_at_top_left,rgba(244,63,94,0.14),transparent_28%),radial-gradient(circle_at_bottom_right,rgba(251,191,36,0.14),transparent_24%),linear-gradient(180deg,#fff8f8,#f8fafc)] p-6">
      ...
      <div className="z-10 my-auto flex w-full max-w-md flex-col items-center space-y-8 animate-fade-in">
