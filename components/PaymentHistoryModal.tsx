...
const InvoiceDetailView: React.FC<{ invoice: PaymentRecord; onBack: () => void; onDownloadInvoice: () => void }> = ({
  invoice,
  onBack,
  onDownloadInvoice,
}) => (
      ...
      <div className="bg-white rounded-t-[2.5rem] w-full max-w-md shadow-2xl border-t border-gray-100 animate-slide-up flex flex-col h-[90vh]">
        ...
        {selectedInvoice ? (
          <InvoiceDetailView
            ...
            onDownloadInvoice={() => setToastMessage('Download da nota fiscal iniciado (simulado).')}
          />
        ) : (
