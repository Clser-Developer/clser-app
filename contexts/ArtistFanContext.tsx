...
export const ArtistFanProvider = ({ artistId, initialFanPoints, children }: ArtistFanProviderProps) => {
  const artistFanState = usePersistentArtistState(artistId, initialFanPoints);
