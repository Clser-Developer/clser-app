...
const ArtistBottomNav: React.FC<ArtistBottomNavProps> = ({ activeSection, onSectionChange }) => {
  return (
    <nav className="sticky bottom-0 left-0 right-0 h-16 bg-white/95 backdrop-blur-md border-t border-gray-100 flex justify-around z-20 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] pb-safe">
      <NavItem 
        label="Visão Geral" 
        iconName="dashboard" 
