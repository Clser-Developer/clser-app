...
const EditProfileModal: React.FC<EditProfileModalProps> = ({ isVisible, onClose, initialTab = 'personal' }) => {
  ...
  const renderPersonalForm = () => (
    <div className="space-y-4">
      ...
      <div>
       ...
       <div>
        <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1.5 ml-1">CPF</label>
        <Input type="text" value={localCpf} onChange={e => setLocalCpf(e.target.value)} className="h-auto rounded-2xl border-gray-100 bg-gray-50 p-4 font-bold text-gray-900 shadow-none" />
      </div>
  ...
  const renderAddressForm = () => (
    <div className="space-y-4">
        ...
        <div>
            <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1.5 ml-1">Estado</label>
