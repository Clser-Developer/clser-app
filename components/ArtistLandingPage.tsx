...
const ArtistLandingPage: React.FC<ArtistLandingPageProps> = ({ artist, onBack, onSubscribe, onViewImage }) => {
  ...
  return (
    <div className="safe-screen bg-white flex flex-col text-gray-900 relative">
      ...
      <div className="safe-bottom-pad sticky bottom-0 left-0 right-0 bg-white border-t border-gray-100 z-20 px-4 pt-4">
          <button
            onClick={handleJoin}
